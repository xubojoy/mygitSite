...
- (void)viewDidLoad
{
    ...
    self.view.backgroundColor = RGBACOLOR(236.f, 236.f, 236.f, 1);
    _statusBarView = [[UIImageView alloc] initWithFrame:CGRectMake(0.f, 0.f, 320, 0.f)];
    _nSpaceNavY = 0;
    if (IOS_7 >= 7 && __IPHONE_OS_VERSION_MAX_ALLOWED > __IPHONE_6_1)
    {
...
{
    UIImageView *navIV = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, self.view.width, 64 - _nSpaceNavY)];
    navIV.tag = 98;
